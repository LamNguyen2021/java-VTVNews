...
<body>
	...
	<div id="logreg-form"
		...
		<form:form action="${pageContext.request.contextPath }/admin/danhmuc/suaDanhMuc" method="post" modelAttribute="danhmuc" style="width:100%; margin:auto;">
			<div>
			...
			<div style="padding: 10px;">
				...
				<form:input path="madanhmuc" type="text" class="form-control" readonly="true"/>
			...
			<a href="${pageContext.request.contextPath }/admin/danhmuc" id="cancel_signup" style="font-size: 16px; margin: 10px; color: #000;">
