		...
		<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #b70002">
			...
			<li class="nav-item" style="padding: 5px 0">
				...
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a style="padding: 20px 10px;" href="${pageContext.request.contextPath }/admin/themBaiBao">
							<button style="    font-size: 14px;border: 1px solid #b70002;background-color: #b70002;color: #fff;padding: 5px;border-radius: 3px;">
			...
			<li class="nav-item" style="padding: 5px 0">
				<a class="nav-link" href="${pageContext.request.contextPath }/admin/danhmuc">
					<i class="fa fa-book-open" style="font-size: 16px"></i>
					<span style="font-size: 16px">Danh mục</span>
				</a>
			</li>
